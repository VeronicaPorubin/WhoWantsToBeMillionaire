...
public class WhileDevopsGame {
    ...
    public void startGame() {
        ...
        while (answer && level <= 10) {
            ...
            switch (gamesAnswers) {
                case A:
                    if (question.getVerifyAns(AnswerSequence.A).isCorrect()) {
                    ...
                    break;
                case B:
                    if (question.getVerifyAns(AnswerSequence.B).isCorrect()) {
                        System.out.println("Is not correct!");
                        System.out.println("Final score: " + totalScore);
                        answer = false;
                    } else {
                    ...
                    break;
                case C:
                    if (question.getVerifyAns(AnswerSequence.C).isCorrect()) {
                        System.out.println("Is correct: ");
                        totalScore += question.getScore();
                        System.out.println("Score: " + totalScore);
                    } else {
                    ...
                    break;
                case D:
                    if (question.getVerifyAns(AnswerSequence.D).isCorrect()) {
                        System.out.println("Is correct: ");
                        totalScore += question.getScore();
                        System.out.println("Score: " + totalScore);
                    } else {
            ...
            //   if (Answer.AnswerSequence.isCorrect()) {
            //       System.out.println("Is correct: ");
            //       totalScore += question.getScore();
            //       System.out.println("Score: " + totalScore);
            //   } else {
    ...
    private Question[] initQuestion() {
        ...
        //    questionArrayList.add(new Question("Cine a scris poezia:'Fiind baiet, paduri cutreieram':", 1, 100, new Answer[]{question1Answer1, question1Answer2, question1Answer3, question1Answer4});
        ...
        Answer question4Answer4 = new Answer("Sydney", false, AnswerSequence.C);
